...
parser.add_argument('--ALGO', default="A2C", type=str)
parser.add_argument('--env_id', default="BreakoutNoFrameskip-v4", type=str)
parser.add_argument('--SEED', default=0, type=int)
parser.add_argument('--NUM_ENVS', default=16, type=int)
parser.add_argument('--TRAIN_STEPS', default=1E4, type=int)
